...
#-Half done, block cannot be placed, but user isn't warned yet. 
...
SCREEN_WIDTH = 1280
SCREEN_HEIGHT = 720
SCREEN_TITLE = "Random tweaks and improvements"
...
class MainMenuView(arcade.View):
    ...
    def level_Play(self, event):
        ...
        if check_Level_Exists(file_Name_Play):
            ...
            self.manager.disable()
            game_view = PlatformerView(r"C:\Users\AToll\OneDrive\Desktop\LevelCreator\Levels\\" + file_Name_Play)
            game_view.setup()
